...
// ===================================================================================================================================
    ...
    let hashes = get_sha256_of_commitments(coms2.clone(), "", 12);
    let alpha = hashes[0];
    let etas = &hashes[4..12];
...
// ===================================================================================================================================
    ...
    assert!((evals2[1][1] - evals2[1][0] - evals0[1][0] * a_r_alpha) * n_1_of_alpha  == evals2[2][0] * domain.evaluate_vanishing_polynomial(alpha));
